...
app.get('/puppies/chipped', async (req, res, next) => {
    ...
    // Your code here 
    chippedPuppies = await Puppy.findAll({where: {microchipped: true}});
...
app.get('/puppies/name/:name', async (req, res, next) => {
    ...
    puppyByName = await Puppy.findOne({where: {name: puppyName}})
...
app.get('/puppies/shepherds', async (req, res, next) => {
    ...
    shepherds = await Puppy.findAll({where: {
...
app.get('/puppies/:id', async (req, res, next) => {
    ...
    puppyById = await Puppy.findOne({where: {
        id: id
    }})
